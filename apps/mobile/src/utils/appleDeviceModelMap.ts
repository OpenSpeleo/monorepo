/**
 * Apple hardware identifier to marketing name mapping.
 *
 * Source used for identifier/name pairs:
 * https://raw.githubusercontent.com/AnbalaganD/iModels/refs/heads/main/Sources/iModels/Device.swift
 *
 * Notes:
 * - This is intentionally vendored so UA formatting is deterministic offline.
 * - Unknown identifiers should gracefully fall back to the raw identifier.
 */

const APPLE_DEVICE_MODEL_BY_IDENTIFIER: Record<string, string> = {
  'iPhone1,1': 'iPhone',
  'iPhone1,2': 'iPhone 3G',
  ...
  'RealityFamily22,1': 'Apple Vision',
};

export function getAppleMarketingModelName(identifier: string): string | undefined {
  return APPLE_DEVICE_MODEL_BY_IDENTIFIER[identifier];
}
